...
class Noise {
    ...
    public void addetiveNoise(double percentage) {
        ...
        try {
            ...
            System.out.print("Error Occoured during Noise output");
        }
    }
...
class ImageWithFilter {
    ...
    BufferedImage image1o;
    BufferedImage image2;
    BufferedImage image2o;
    String outputFileName;
    ...
    ImageWithFilter(BufferedImage obj) {
        ...
        file3 = new File("./grayScale.jpg");
        this.image2 = obj;
        try {
            this.image2o = ImageIO.read(file2);
            this.image1o = ImageIO.read(file3);
        } catch (Exception e) {
            System.out.println("Error");
        }
    ...
    public void meanFilter(String outputFileName) {
        ...
        try {
            file = new File(outputFileName);
            ImageIO.write(this.image1o, "jpg", file);
        } catch (Exception e) {
            System.out.print("Error Occoured during meanFilter output");
        }
    }
    ...
    public void medianFilter(String outputFileName) {
        ...
        try {
            file = new File(outputFileName);
            ImageIO.write(this.image2o, "jpg", file);
            // test purpose
            file = new File("MedianTest.jpg");
            ImageIO.write(this.image2, "jpg", file);
        } catch (Exception e) {
            System.out.print("Error Occoured during medianFilter output");
        }
    }
    ...
    public void matrixCalmedianFilter(int y, int x) {
        ...
        // image2o.setRGB(x + 1, y + 1, p);// feeding
        int median = arr[4][0];
        a = 255;
        p = (a << 24) | (median << 16) | (median << 8) | median;
        image2o.setRGB(x + 1, y + 1, p);
    }
    // median filter end
...
public class Main {
    public static void main(String args[]) throws IOException {
        ...
        String outputFileName = "manna_grayScale.jpg";// output file name with extension
